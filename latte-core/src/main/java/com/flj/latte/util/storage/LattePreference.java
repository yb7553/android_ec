...
public final class LattePreference {
    ...
    public static JSONObject getAppProfileJson() {
        ...
        return JSON.parseObject(profile).getJSONObject("data");
    }
    ...
    public static void addCustomAppProfileLong(String key, Long val) {
        getAppPreference()
                .edit()
                .putLong(key, val)
                .apply();
    ...
    public static Long getCustomAppProfileLong(String key) {
