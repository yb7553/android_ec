...
public class Router {
    ...
    private void loadContent(WebView webView,String Content){
        webView.loadDataWithBaseURL(null, Content, "text/html", "utf-8",null);
    }

    public final void loadContent(WebDelegate delegate, String Content) {
        loadContent(delegate.getWebView(), Content);
    }
