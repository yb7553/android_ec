...
public class SendTime implements View.OnClickListener {
    ...
    private SendTime(LatteDelegate delegate) {
        this.mActivity = delegate.getProxyActivity();
        this.mDialog = new AlertDialog.Builder(delegate.getContext()).create();
    }

    public static SendTime create(LatteDelegate delegate) {
        return new SendTime(delegate);
    }

    public void beginSendDialog() {
        mDialog.show();
        final Window window = mDialog.getWindow();
        if (window != null) {
            window.setContentView(R.layout.dialog_send_panel);
            ...
            window.findViewById(R.id.btn_dialog_order_cancel).setOnClickListener(this);
            window.findViewById(R.id.btn_dialog_order_cancel).setOnClickListener(this);
            window.findViewById(R.id.btn_dialog_order_cancel).setOnClickListener(this);
        }
    }
    ...
    public SendTime setOrderId(int orderId) {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_dialog_order_cancel) {
            alPay(mOrderID);
            mDialog.cancel();
        } else if (id == R.id.btn_dialog_send_time) {
            weChatPay(mOrderID);
            mDialog.cancel();
